...
отправить . addEventListener ( 'щелчок' ,  function ( ) {
    ...
    if  ( lastname_field . value == "" ) {
        ...
        lastname_field . стиль . borderColor  =  "черный" ;
    }
    if  ( phone_field . value == "" ) {
        phone_field . стиль . borderColor  =  "красный" ;
        че  =  1 ;
    }
    else {
        phone_field . стиль . borderColor  =  "черный" ;
    }
    if  ( che  ==  0 ) {
        отправить1 . innerHTML  =  "Уважаемый"  +  lastname_field . значение  +  ""  +  firstname_field . значение  +  "." ;
        отправить2 . innerHTML  =  "Мы получили вашу заявку и вскором времени позвоним вам по номеру"  +  phone_field . значение  +  "." ;
    }
    
} )
    окно . onscroll  =  function ( )  {
        docScroll  ( ) ;
    }
    function  docScroll  ( ) {
        пусть  windowScroll  =  document . тело . scrollTop  ||  документ . documentElement . scrollTop ;
        пусть  documentheight  =  document . documentElement . scrollHeight  -  документ . documentElement . clientHeight ;
        пусть  прокручивается  =  windowScroll / documentheight * 100 ;
        scro . стиль . ширина  =  прокручивается  +  '%'
        if  ( прокручено  <  30 ) {
            акт1 . стиль . цвет  =  "красный" ;
            акт2 . стиль . цвет  =  "черный" ;
            акт3 . стиль . цвет  =  "черный" ;
            акт4 . стиль . цвет  =  "черный" ;
            вер . стиль . display  =  "нет" ;
        }
        if  ( прокручено  >  30 ) {
            акт1 . стиль . цвет  =  "черный" ;
            акт2 . стиль . цвет  =  "красный" ;
            акт3 . стиль . цвет  =  "черный" ;
            акт4 . стиль . цвет  =  "черный" ;
            вер . стиль . display  =  "блок" ;
        }
        if  ( прокручено  >  65 ) {
            акт1 . стиль . цвет  =  "черный" ;
            акт2 . стиль . цвет  =  "черный" ;
            акт3 . стиль . цвет  =  "красный" ;
            акт4 . стиль . цвет  =  "черный" ;
        }
        if  ( прокручено  >  80 ) {
            акт1 . стиль . цвет  =  "черный" ;
            акт2 . стиль . цвет  =  "черный" ;
            акт3 . стиль . цвет  =  "черный" ;
            акт4 . стиль . цвет  =  "красный" ;
        }
    }
    пусть  korz  =  0
    aq1 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        Summ  =  Summ  +  36865000 ;
    } ) ;
    aq2 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        сумма  =  сумма  +  156000 ;
    } ) ;
    aq3 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        Summ  =  Summ  +  +96365000 ;
    } ) ;
    aq4 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        Summ  =  Summ  +  +66835000 ;
    } ) ;
    aq5 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        сумма  =  сумма  +  123000 ;
    } ) ;
    aq6 . addEventListener ( "клик" ,  function ( ) {
        ab . innerHTML  =  '<img src = "img / cart25.png">'  +  ( korz  +  1 ) ;
        корз  =  корз  +  1 ;
        сумма  =  сумма  +  100000 ;
    } ) ;
    ab . addEventListener ( 'щелчок' ,  function ( ) {
        alert ( "Итогавая цена заказа:"  +  сумма  +  "$" ) ;
    } )
</ скрипт >
</ body >
</ html >
